!function(ng){ng.module("D6App",["ngRoute","firebase"]).value("FirebaseUrl","https://d6powers.firebaseio.com/").config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){"use strict";$routeProvider.when("/",{controller:"ListCtlr",templateUrl:"/views/app/home.html"}).when("/login",{templateUrl:"/views/app/login.html"}).when("/new",{controller:"NewCtlr",templateUrl:"/views/app/view.html"}).when("/view/:uid/:id",{controller:"ViewCtlr",templateUrl:"/views/app/view.html"}).when("/view/:uid",{controller:"ListCtlr",templateUrl:"/views/app/home.html"}).otherwise({redirectTo:"/"}),$locationProvider.html5Mode(!0)}])}(angular);
...
!function(ng){ng.module("D6App").controller("ListCtlr",["$scope","$routeParams","D6CharacterList",function($scope,$routeParams,CharacterList){"use strict";$scope.characters=new CharacterList($routeParams.uid)}])}(angular);
