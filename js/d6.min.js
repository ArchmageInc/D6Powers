!function(ng){ng.module("D6App",["ngRoute","firebase"]).value("FirebaseUrl","https://d6powers.firebaseio.com/").config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){"use strict";$routeProvider.when("/",{controller:"HomeCtlr",templateUrl:"/D6App/views/app/home.html"}).when("/login",{templateUrl:"/D6App/views/app/login.html"}).when("/new",{controller:"NewCtlr",templateUrl:"/D6App/views/app/view.html"}).when("/view/:uid/:id",{controller:"ViewCtlr",templateUrl:"/D6App/views/app/view.html"}).otherwise({redirectTo:"/"}),$locationProvider.html5Mode(!0)}])}(angular);
...
!function(ng){ng.module("D6App").directive("d6Toolbox",[function(){"use strict";return{restrict:"E",templateUrl:"/D6App/views/ui/toolbox.html",controller:"ToolboxCtlr",link:function($scope,$el){$scope.$watch("toolbox.open",function(newValue){newValue?$el.addClass("open"):$el.removeClass("open")})}}}])}(angular);
