!function(ng){ng.module("D6App",["ngRoute","firebase"]).value("FirebaseUrl","https://resplendent-inferno-5462.firebaseio.com/D6Powers").config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){"use strict";$routeProvider.when("/",{controller:"HomeCtlr",templateUrl:"/D6App/views/app/home.html"}).when("/login",{templateUrl:"/D6App/views/app/login.html"}).when("/new",{controller:"NewCtlr",templateUrl:"/D6App/views/app/view.html"}).when("/view/:uid/:id",{controller:"ViewCtlr",templateUrl:"/D6App/views/app/view.html"}).otherwise({redirectTo:"/"}),$locationProvider.html5Mode(!0)}])}(angular);
...
!function(ng){ng.module("D6App").factory("D6CharacterTools",["$window","$q","D6Tool",function($window,$q,Tool){"use strict";function D6CharacterTools(character,confirmations){this.tools=[new Tool({icon:"spinner5",name:"Regenerate",description:"Regenerate Character",show:function(){return character.new},use:function(){if(character.controls.changes){var def=$q.defer();def.promise.then(function(){character.regenerate()}).finally(function(){confirmations.abort.confirmation=null}),confirmations.abort.confirmation=def}else character.regenerate()}}),new Tool({icon:"blocked",name:"cancel",description:"Cancel Changes",show:function(){return character.controls.editing},use:function(){if(character.controls.changes){var def=$q.defer();def.promise.then(function(){character.undoAll()}).finally(function(){confirmations.abort.confirmation=null}),confirmations.abort.confirmation=def}else character.undoAll()}}),new Tool({icon:"undo",name:"undo",description:"Undo Change",show:function(){return character.controls.editing},disable:function(){return character.controls.revision<=1},use:function(){character.undo()}}),new Tool({icon:"redo",name:"redo",description:"Redo Change",show:function(){return character.controls.editing},disable:function(){return character.controls.revision>=character.controls.revisions.length},use:function(){character.redo()}}),new Tool({icon:"disk",name:"save",description:"Save Character",show:function(){return character.editable},disable:function(){return!character.controls.changes},use:function(){character.save()}}),new Tool({icon:"pencil",name:"edit",description:"Edit Character",show:function(){return!character.controls.editing&&character.editable},use:function(){character.edit()}}),new Tool({icon:"remove2",name:"delete",description:"Delete Character",show:function(){return character.controls.editing&&character.editable},disable:function(){return character.new},use:function(){var def=$q.defer();def.promise.then(function(){character.remove()}).finally(function(){confirmations.remove.confirmation=null}),confirmations.remove.confirmation=def}}),new Tool({icon:"print",name:"print",description:"Print Character",show:function(){return!character.controls.editing},use:function(){$window.print()}})]}return D6CharacterTools.prototype={tools:[]},D6CharacterTools}])}(angular);
...
!function(ng){ng.module("D6App").directive("d6CharacterSheet",[function(){"use strict";return{restrict:"E",controller:"CharacterCtlr",templateUrl:"/D6App/views/character/character-sheet.html",scope:{character:"=d6Scope"}}}])}(angular);
...
!function(ng){ng.module("D6App").directive("d6Dialog",[function(){"use strict";return{restrict:"E",templateUrl:"/D6App/views/ui/dialog.html",transclude:!0,scope:{control:"=d6Control"}}}])}(angular);
